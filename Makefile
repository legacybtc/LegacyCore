...
package-linux:
	bash scripts/package-linux.sh v1.0.7 amd64

package-linux-arm64:
	bash scripts/package-linux.sh v1.0.7 arm64
...
package-windows:
	powershell.exe -ExecutionPolicy Bypass -File scripts/package-windows.ps1 -Version v1.0.7

release-source:
	powershell.exe -ExecutionPolicy Bypass -File scripts/release-source-archive.ps1 -Version v1.0.7 -OutputDir dist
