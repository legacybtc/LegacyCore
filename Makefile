...
package-windows:
	powershell.exe -ExecutionPolicy Bypass -File scripts/package-windows.ps1 -Version v1.0.4

release-source:
	powershell.exe -ExecutionPolicy Bypass -File scripts/release-source-archive.ps1 -Version v1.0.4 -OutputDir dist
