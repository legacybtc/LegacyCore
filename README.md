...
[![OpenSSF Best Practices](https://bestpractices.coreinfrastructure.org/projects/0/badge)](https://www.bestpractices.dev/projects/0)
...
```bash
bash scripts/package-macos.sh v1.0.13 amd64
```

For Apple Silicon (ARM64):
```bash
bash scripts/package-macos.sh v1.0.13 arm64
```
